...
QString StrConstants::getApplicationCliHelp(){
  QString str =
      "\n" + QObject::tr("OctoPkgin usage help:") + "\n\n" +
...
QString StrConstants::getNetBSDNews(){
  return QObject::tr("NetBSD news");
}
...
QString StrConstants::getIncompatibleBSDFlavourError(){
  return QObject::tr("This BSD flavour seems to be incompatible with OctoPkgin!");
}
...
QString StrConstants::getOctoPKGDoasNotFound(){
  return QObject::tr("\"/usr/pkg/bin/qt-sudo\" was not found!");
}

QString StrConstants::getErrorNoPkgFound(){
  return QObject::tr("'pkgin' binary was not found.");
}
...
QString StrConstants::getErrorRunningWithRoot(){
  return QObject::tr("You can not run OctoPkgin with administrator's credentials.");
}
