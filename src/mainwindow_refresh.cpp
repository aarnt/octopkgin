...
#include "uihelper.h"
#include "globals.h"
#include "src/ui/octopkgintabinfo.h"
#include <iostream>
#include <cassert>
...
void MainWindow::remoteSearchClicked()
{
  ...
  //qDebug() << "Came at 144 of MAINWINDOW_REFRESH";
...
void MainWindow::refreshTabInfo(QString pkgName)
{
  ...
  {
    text->clear();    
    text->setHtml(OctopkginTabInfo::formatTabInfo(*package, *m_outdatedList));
    text->scrollToAnchor(OctopkginTabInfo::anchorBegin);
