...
const QString ctn_ORGANIZATION("octopkgin");
const QString ctn_APPLICATION("octopkgin");
...
class SettingsManager
{
  ...
  public:
    ...
    static QString getOctoPkgConfPath()
    {
      return QDir::homePath() +
          QDir::separator() + ".config/octopkgin/octopkgin.conf";
    }
